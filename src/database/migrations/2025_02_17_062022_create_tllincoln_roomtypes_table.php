...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('tllincoln_roomtypes', function (Blueprint $table) {
            ...
            $table->bigInteger('tllincoln_roomtype_image_updated_at')->nullable();
