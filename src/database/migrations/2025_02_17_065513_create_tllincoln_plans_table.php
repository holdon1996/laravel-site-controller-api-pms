...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tllincoln_plans', function (Blueprint $table) {
            ...
            $table->integer('tllincoln_plan_updated_at')->nullable();
